...
public class edit_goal extends Fragment implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        startDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogFragment startDateFragment = new DatePickerFragment(edit_goal.this);
        ...
        endDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction ft = getFragmentManager().beginTransaction();
                DialogFragment endDateFragment = new DatePickerFragment(edit_goal.this);
        ...
        startTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction ft = getFragmentManager().beginTransaction();
                DialogFragment startTimeFragment = new TimePickerFragment(edit_goal.this);
        ...
        endTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction ft = getFragmentManager().beginTransaction();
                DialogFragment endTimeFragment = new TimePickerFragment(edit_goal.this);
